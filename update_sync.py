# Fájlnév: update_sync.py
import os

# Ez a tartalom kerül a service fájlba
new_code = r'''# Version: 1.2.1 - Booksy Agentic Sync (Strict SKU separation, No Merge Fix)
import os
import logging
import json
...
target_path = os.path.join('src', 'services', 'product_sync_service.py')

# Fájl írása UTF-8 kódolással
with open(target_path, 'w', encoding='utf-8') as f:
    f.write(new_code)

print(f"SIKER: A {target_path} fájl frissítve lett a szigorú SKU logikával!")